...
def run_lns_sa_experiment(
    ...
    print("\n===================================")
    print("WORST + GREEDY HYBRID LNS OUTPUT FOLDER")
    print("===================================")
    print(save_path)
    ...
    lns_metrics = {
        "algorithm": "hybrid_supplier_customer_lns_sa_no_cluster_worst_greedy_v1",
    ...
    plot_supplier_routes(
        ...
        title="Case 3 Hybrid No-Cluster + Worst Greedy LNS-SA Routes",
        depot_cord=depot_cord,
    )

    print("\n===================================")
    print("HYBRID WORST + GREEDY LNS-SA COMPLETE")
    print("===================================")
