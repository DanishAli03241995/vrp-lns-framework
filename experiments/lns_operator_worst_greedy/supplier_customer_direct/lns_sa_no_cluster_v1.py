...
lns_sa_module = importlib.import_module(
    "metaheuristics.operator_pair_engines.lns_sa_worst_greedy_v1"
)

run_lns_sa_worst_greedy = lns_sa_module.run_lns_sa_worst_greedy
...
def run_lns_sa_experiment(
    ...
    print("\n===================================")
    print("WORST + GREEDY LNS OUTPUT FOLDER")
    print("===================================")
    print(save_path)
    ...
    lns_metrics = {
        "algorithm": "supplier_customer_lns_sa_no_cluster_worst_greedy_v1",
    ...
    plot_supplier_routes(
        ...
        title="Case 2 Direct No-Cluster + Worst Greedy LNS-SA Routes",
    )

    print("\n===================================")
    print("WORST + GREEDY LNS-SA COMPLETE")
    print("===================================")
