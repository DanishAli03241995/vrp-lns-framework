...
Loads the latest hybrid KMeans baseline run, applies LNS-SA separately to:
...
def run_lns_sa_experiment(
    ...
    lns_metrics = {
        "algorithm": "hybrid_supplier_customer_lns_sa_kmeans_v1",
    ...
    plot_supplier_routes(
        ...
        title="Case 3 Hybrid KMeans + LNS-SA Routes",
        depot_cord=depot_cord,
    )
