"""
Case 3: Hybrid Supplier-Customer + Sweep + LNS-SA.

Loads the latest hybrid sweep baseline run, applies LNS-SA separately to:
...
def run_lns_sa_experiment(
    ...
    lns_metrics = {
        "algorithm": "hybrid_supplier_customer_lns_sa_sweep_v1",
    ...
    plot_supplier_routes(
        ...
        title="Case 3 Hybrid Sweep + LNS-SA Routes",
        depot_cord=depot_cord,
    )
