...
# Hybrid Supplier-Customer KMeans baseline with fixed depot timing evaluation
...
from utils import depot_timing_utils
...
def run_experiment(config):
    ...
    if len(global_depot_customer_cord) > 0:
        ...
        global_depot_timing_records = (
            depot_timing_utils.evaluate_fixed_depot_routes(
    ...
    results_path = create_experiment_folder(
        "hybrid_supplier_customer_kmeans_timing_fixed_v1",
        INSTANCE_NAME,
    )
    ...
    metrics = {
        "algorithm": "hybrid_supplier_customer_kmeans_timing_fixed_v1",
