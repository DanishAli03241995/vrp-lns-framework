...
def run_lns_sa_experiment(
    ...
    print("\n===================================")
    print("WORST + REGRET LNS OUTPUT FOLDER")
    print("===================================")
    print(save_path)
    ...
    lns_metrics = {
        "algorithm": "supplier_customer_lns_sa_no_cluster_worst_regret_v1",
    ...
    plot_supplier_routes(
        ...
        title="Case 2 Direct No-Cluster + Worst Regret LNS-SA Routes",
    )

    print("\n===================================")
    print("WORST + REGRET LNS-SA COMPLETE")
    print("===================================")
