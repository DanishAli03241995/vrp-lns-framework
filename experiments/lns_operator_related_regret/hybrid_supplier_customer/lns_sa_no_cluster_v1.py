...
def run_lns_sa_experiment(
    ...
    print("\n===================================")
    print("RELATED + REGRET HYBRID LNS OUTPUT FOLDER")
    print("===================================")
    print(save_path)
    ...
    lns_metrics = {
        "algorithm": "hybrid_supplier_customer_lns_sa_no_cluster_related_regret_v1",
    ...
    plot_supplier_routes(
        ...
        title="Case 3 Hybrid No-Cluster + Related Regret LNS-SA Routes",
        depot_cord=depot_cord,
    )

    print("\n===================================")
    print("HYBRID RELATED + REGRET LNS-SA COMPLETE")
    print("===================================")
