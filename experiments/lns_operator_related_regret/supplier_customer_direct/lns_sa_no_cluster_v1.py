...
run_lns_sa_related_regret = lns_sa_module.run_lns_sa_related_regret
...
def run_lns_sa_experiment(
    ...
    print("\n===================================")
    print("RELATED + REGRET LNS OUTPUT FOLDER")
    print("===================================")
    print(save_path)
    ...
    lns_metrics = {
        "algorithm": "supplier_customer_lns_sa_no_cluster_related_regret_v1",
    ...
    plot_supplier_routes(
        ...
        title="Case 2 Direct No-Cluster + Related Regret LNS-SA Routes",
    )

    print("\n===================================")
    print("RELATED + REGRET LNS-SA COMPLETE")
    print("===================================")
