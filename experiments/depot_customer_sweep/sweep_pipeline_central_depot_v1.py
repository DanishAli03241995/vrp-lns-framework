"""Run generated depot-customer Sweep pipeline with the depot at map center."""
...
from experiments.depot_customer_sweep import sweep_pipeline_v1 as base
from instances.generate_depot_customer_instance import get_grid_size


base.ALGORITHM_NAME = "generated_depot_customer_sweep_initial_pipeline_central_depot"
...
if __name__ == "__main__":
    for experiment_config in build_experiments():
        print("\n===================================")
        print("Running generated central-depot Sweep experiment:")
