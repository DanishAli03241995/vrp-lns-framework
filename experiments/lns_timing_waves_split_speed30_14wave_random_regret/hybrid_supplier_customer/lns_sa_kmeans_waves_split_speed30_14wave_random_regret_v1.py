...
dispatch_wave_lns_module = importlib.import_module(
    ...
    "lns_sa_random_regret_dispatch_wave_speed30_14wave_v1"
)
...
run_lns_sa_random_regret_dispatch_wave_timing = (
    dispatch_wave_lns_module.run_lns_sa_random_regret_dispatch_wave_speed30_14wave
)
...
def build_default_output_path(instance_name):
    ...
    return os.path.join(
        ROOT_DIR,
        "results",
        "lns_timing_waves_split_speed30_14wave_random_regret",
        "case3_kmeans",
        instance_name,
    )
...
def add_depot_timing_record_metadata(records):
    ...
    for record in records:
        ...
        enriched_record["operator_pair"] = "random_regret_dispatch_wave_speed30_14wave"
...
def run_lns_sa_experiment(
    ...
    print("\n===================================")
    print("DISPATCH-WAVE SPEED30 + 14:00 WAVE SPLIT + RANDOM REGRET LNS OUTPUT FOLDER")
    print("===================================")
    print(save_path)
    ...
    if 14.0 not in dispatch_waves:
        raise ValueError(
            "This LNS case requires the added 14:00 dispatch wave. "
    ...
    with open(
        os.path.join(save_path, "route_lns_sa_dispatch_wave_speed30_14wave_random_regret.txt"),
        "w",
    ) as file_handle:
        file_handle.write(str(all_lns_routes))
    ...
    lns_metrics = {
        ...
        "operator_pair": "random_regret_dispatch_wave_speed30_14wave",
        ...
        "dispatch_wave_sensitivity_case": "added_14_00_wave",
    ...
    try:
        plot_supplier_routes(
            ...
            title=(
                "Case 3 KMeans Dispatch-Wave Speed30 + 14:00 Wave Split + Random-Regret LNS"
            ),
            depot_cord=depot_cord,
        )
    ...
    print("\n===================================")
    print("DISPATCH-WAVE SPEED30 + 14:00 WAVE RANDOM-REGRET LNS SUMMARY")
    print("===================================")
