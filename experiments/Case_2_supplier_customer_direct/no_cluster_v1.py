# Experiment entry point: Supplier -> Customer baseline without internal clustering
...
def run_experiment(config):
    ...
    # ======================================================
    # Supplier assignment remains active.
    # Internal sweep/KMeans clustering is removed.
    # ======================================================
    ...
    # ======================================================
    # Supplier-level routing without internal clustering
    # ======================================================
    ...
    for supplier_id, subproblem in supplier_subproblems.items():
        ...
        # ------------------------------------------------------
        # No clustering:
        # one supplier-level customer pool is routed directly.
        # ------------------------------------------------------

        supplier_customer_pool = list(supplier_customer_cord.keys())
        all_clusters.append(supplier_customer_pool)
        ...
        # ======================================================
        # Baseline NN directly on full supplier customer pool
        # ======================================================
        ...
        supplier_two_opt_routes = baseline_nn_2opt_relocation_2opt_v1.run_2opt(
            supplier_routes,
        ...
        # ======================================================
        # Relocation + post-relocation 2-opt
        # ======================================================
        ...
        supplier_metrics[supplier_id] = {
            ...
            "clusters": [supplier_customer_pool],
    ...
    results_path = create_experiment_folder(
        "supplier_customer_only_no_cluster_v1",
        INSTANCE_NAME,
    )
    ...
    metrics = {
        "algorithm": "supplier_customer_only_no_cluster_v1",
        "instance": INSTANCE_NAME,
        "seed": config["seed"],
        "construction": "angular_partition + no_internal_clustering + nearest_neighbor + 2-opt",
    ...
    plot_supplier_routes(
        ...
        title="Supplier-Level Routes - Angular Partition + No Clustering + Baseline NN",
    )
    ...
    plot_supplier_routes(
        ...
        title="Supplier-Level Routes - Angular Partition + No Clustering + Baseline NN + 2-Opt",
    )
    ...
    plot_supplier_routes(
        ...
        title="Supplier-Level Routes - Angular Partition + No Clustering + 2-Opt + Supplier-Level Relocation",
    )
    ...
    plot_supplier_routes(
        ...
        title="Supplier-Level Routes - Angular Partition + No Clustering + 2-Opt + Supplier-Level Relocation + 2-Opt",
    )
