"""Runner for Case 2 supplier-customer direct no-cluster baseline."""
...
experiment_module = importlib.import_module(
    "experiments.Case_2_supplier_customer_direct.no_cluster_v1"
)

run_experiment = experiment_module.run_experiment


ALGORITHM_NAME = "supplier_customer_only_no_cluster_v1"
...
for config in experiments:
    ...
    print("\n===================================")
    print("Running Case 2 No-Cluster experiment:")
    print(config)
    print("===================================\n")
