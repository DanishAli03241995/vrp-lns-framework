"""Runner for Case 2 supplier-customer direct Sweep baseline."""
...
experiment_module = importlib.import_module(
    "experiments.Case_2_supplier_customer_direct.baseline_sweep_v1"
)

run_experiment = experiment_module.run_experiment


ALGORITHM_NAME = "supplier_customer_only_baseline_sweep_v1"
...
for config in experiments:
    ...
    print("\n===================================")
    print("Running Case 2 Sweep experiment:")
    print(config)
    print("===================================\n")
