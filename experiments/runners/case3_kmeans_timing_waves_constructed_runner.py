"""Runner for Case 3 Hybrid + KMeans with wave-aware depot dispatch construction."""
...
experiment_module = importlib.import_module(
    "experiments.Case_3_hybrid_supplier_customer.baseline_kmeans_timing_waves_constructed_v1"
)

run_experiment = experiment_module.run_experiment


ALGORITHM_NAME = "hybrid_supplier_customer_kmeans_timing_waves_constructed_v1"
...
for config in experiments:
    ...
    print("\n===================================")
    print("Running Case 3 KMeans wave-aware depot dispatch construction experiment:")
    print(config)
    print("===================================\n")
