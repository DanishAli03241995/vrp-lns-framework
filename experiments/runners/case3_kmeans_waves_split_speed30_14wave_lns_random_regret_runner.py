"""
Runner for Case 3 Hybrid KMeans dispatch-wave timing + split repair + added 14:00 wave + LNS-SA.
...
Timing behavior:
- starts from the dispatch-wave speed30 + 14:00-wave split-repaired baseline;
- depot-side LNS is dispatch-wave aware;
- depot customers stay inside their assigned dispatch-wave bucket;
- supplier-direct LNS uses the standard random-regret LNS engine.
"""
...
VARIANT_NAME = "kmeans_dispatch_wave_split_speed30_14wave"
STAGE_NAME = "lns_waves_split_speed30_14wave_random_regret"
TARGET_MODULE = (
    "experiments.lns_timing_waves_split_speed30_14wave_random_regret."
    "hybrid_supplier_customer."
    "lns_sa_kmeans_waves_split_speed30_14wave_random_regret_v1"
)

BASELINE_RESULTS_NAME = "hybrid_supplier_customer_kmeans_timing_waves_constructed_split_14wave_v1"
LNS_RESULTS_NAME = "lns_timing_waves_split_speed30_14wave_random_regret/case3_kmeans"
ROUTE_SCOPE = "hybrid"
