"""
Runner for Case 3 Hybrid KMeans dispatch-wave timing + split repair + speed30 + added 14:00 wave + LNS-SA.
...
STAGE_NAME = "lns_waves_split_speed30_14wave_related_regret"
TARGET_MODULE = (
    "experiments.lns_timing_waves_split_speed30_14wave_related_regret."
    "hybrid_supplier_customer."
    "lns_sa_kmeans_waves_split_speed30_14wave_related_regret_v1"
)

BASELINE_RESULTS_NAME = "hybrid_supplier_customer_kmeans_timing_waves_constructed_split_14wave_v1"

LNS_RESULTS_NAME = "lns_timing_waves_split_speed30_14wave_related_regret/case3_kmeans"
ROUTE_SCOPE = "hybrid"
