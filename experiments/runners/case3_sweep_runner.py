"""Runner for Case 3 hybrid supplier-customer Sweep baseline."""
...
experiment_module = importlib.import_module(
    "experiments.Case_3_hybrid_supplier_customer.baseline_sweep_v1"
)

run_experiment = experiment_module.run_experiment


ALGORITHM_NAME = "hybrid_supplier_customer_sweep_v1"
...
for config in experiments:
    ...
    print("\n===================================")
    print("Running Case 3 Sweep experiment:")
    print(config)
    print("===================================\n")
