"""Runner for Case 3 hybrid supplier-customer KMeans with fixed depot timing and split repair."""
...
experiment_module = importlib.import_module(
    "experiments.Case_3_hybrid_supplier_customer.baseline_kmeans_timing_fixed_split_v1"
)

run_experiment = experiment_module.run_experiment


ALGORITHM_NAME = "hybrid_supplier_customer_kmeans_timing_fixed_split_v1"
...
for config in experiments:
    ...
    print("\n===================================")
    print("Running Case 3 KMeans fixed depot timing + split repair experiment:")
    print(config)
    print("===================================\n")
