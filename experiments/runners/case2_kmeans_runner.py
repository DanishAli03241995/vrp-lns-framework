"""Runner for Case 2 supplier-customer direct KMeans baseline."""
...
experiment_module = importlib.import_module(
    "experiments.Case_2_supplier_customer_direct.baseline_kmeans_v1"
)

run_experiment = experiment_module.run_experiment


ALGORITHM_NAME = "supplier_customer_only_baseline_kmeans_v1"
...
for config in experiments:
    ...
    print("\n===================================")
    print("Running Case 2 KMeans experiment:")
    print(config)
    print("===================================\n")
