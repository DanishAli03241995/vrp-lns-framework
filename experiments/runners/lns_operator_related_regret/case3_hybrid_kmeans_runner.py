"""Runner for Case 3 Hybrid KMeans LNS-SA with Related + Regret operators."""
...
VARIANT_NAME = "kmeans"
STAGE_NAME = "lns_operator_related_regret"
TARGET_MODULE = (
    "experiments.lns_operator_related_regret."
    "hybrid_supplier_customer.lns_sa_kmeans_v1"
)
BASELINE_RESULTS_NAME = "hybrid_supplier_customer_kmeans_v1"
LNS_RESULTS_NAME = "lns_operator_related_regret/case3_kmeans"
ROUTE_SCOPE = "hybrid"
