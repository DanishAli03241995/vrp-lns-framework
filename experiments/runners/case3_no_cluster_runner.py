"""Runner for Case 3 hybrid supplier-customer no-cluster baseline."""
...
experiment_module = importlib.import_module(
    "experiments.Case_3_hybrid_supplier_customer.baseline_no_cluster_v1"
)

run_experiment = experiment_module.run_experiment


ALGORITHM_NAME = "hybrid_supplier_customer_no_cluster_v1"
...
if RUN_MODE == "test":
    ...
    for n_customers in [20, 40, 60, 80, 100, 150, 200]:
...
for config in experiments:
    ...
    print("\n===================================")
    print("Running Case 3 No-Cluster experiment:")
    print(config)
    print("===================================\n")
