...
STAGE_NAME = "lns_timing_fixed_split_random_regret"
TARGET_MODULE = (
    "experiments.lns_timing_fixed_split_random_regret."
    "hybrid_supplier_customer."
    "lns_sa_kmeans_timing_fixed_split_random_regret_v1"
)
BASELINE_RESULTS_NAME = "hybrid_supplier_customer_kmeans_timing_fixed_split_v1"
LNS_RESULTS_NAME = "lns_timing_fixed_split_random_regret/case3_kmeans"
ROUTE_SCOPE = "hybrid"
BATCH_CUSTOMER_COUNTS = [20, 40, 60, 80]
