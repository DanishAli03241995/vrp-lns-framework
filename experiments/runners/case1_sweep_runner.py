"""Runner for Case 1 supplier-depot-customer Sweep baseline."""
...
experiment_module = importlib.import_module(
    "experiments.Case_1_supplier_depot_customer.baseline_sweep_v1"
)

run_experiment = experiment_module.run_experiment


ALGORITHM_NAME = "supplier_depot_customer_baseline_sweep_v1"
...
for config in experiments:
    ...
    print("\n===================================")
    print("Running Case 1 Sweep experiment:")
    print(config)
    print("===================================\n")
