...
- speed-40 sensitivity baseline is used;
...
- supplier-direct LNS keeps the original Random Removal + Regret-2 logic.
...
dispatch_wave_lns_module = importlib.import_module(
    ...
    "lns_sa_random_regret_dispatch_wave_speed40_v1"
)
standard_lns_module = importlib.import_module(
    "metaheuristics.operator_pair_engines.lns_sa_random_regret_v1"
)

run_lns_sa_random_regret_dispatch_wave_timing = (
    dispatch_wave_lns_module.run_lns_sa_random_regret_dispatch_wave_timing
)
run_lns_sa_random_regret = standard_lns_module.run_lns_sa_random_regret
...
def load_instance_data(latest_run_path, metrics):
    ...
    average_speed = metrics.get("average_speed", 40)
    ...
    return {
        ...
        "config_source": "config_used.json_missing_default_speed40_service10_used",
    }
...
def build_default_output_path(instance_name):
    ...
    return os.path.join(
        ROOT_DIR,
        "results",
        "lns_timing_waves_split_speed40_random_regret",
        "case3_kmeans",
        instance_name,
    )
...
def add_depot_timing_record_metadata(records):
    ...
    for record in records:
        ...
        enriched_record["operator_pair"] = "random_regret_dispatch_wave_speed40"
...
def run_lns_sa_experiment(
    ...
    """Run dispatch-wave speed40 split-repair LNS for one instance."""
    baseline_results_name = "hybrid_supplier_customer_kmeans_timing_waves_constructed_split_v1_40_speed"
    ...
    print("\n===================================")
    print("LATEST DISPATCH-WAVE SPEED40 + SPLIT BASELINE RUN FOLDER")
    print("===================================")
    ...
    print("\n===================================")
    print("DISPATCH-WAVE SPEED40 SPLIT + RANDOM REGRET LNS OUTPUT FOLDER")
    print("===================================")
    print(save_path)
    ...
    dispatch_waves = metrics.get("dispatch_waves", [9.0, 11.0, 13.0, 15.0])
    ...
    if average_speed != 40:
        print("\nWARNING: speed40 LNS case expected average_speed = 40.")
    ...
    for wave, wave_initial_solution in sorted(depot_routes_by_wave.items()):
        ...
        print("\n===================================")
        print(f"DEPOT-SIDE DISPATCH-WAVE LNS - {format_hour(wave)}")
        print("===================================")
    ...
    for supplier_id, supplier_data in supplier_metrics.items():
        ...
        print("\n===================================")
        print(f"SUPPLIER-DIRECT RANDOM REGRET LNS - SUPPLIER {supplier_id}")
        print("===================================")
    ...
    with open(
        os.path.join(save_path, "route_lns_sa_dispatch_wave_speed40_random_regret.txt"),
        "w",
    ) as file_handle:
        file_handle.write(str(all_lns_routes))
    ...
    lns_metrics = {
        "algorithm": (
            "hybrid_supplier_customer_kmeans_waves_split_speed40_"
            "lns_random_regret_v1"
        ),
        ...
        "operator_pair": "random_regret_dispatch_wave_speed40",
    ...
    try:
        plot_supplier_routes(
            ...
            title=(
                "Case 3 KMeans Dispatch-Wave Speed40 Split + Random-Regret LNS"
            ),
            depot_cord=depot_cord,
        )
    ...
    print("\n===================================")
    print("DISPATCH-WAVE SPEED40 RANDOM-REGRET LNS SUMMARY")
    print("===================================")
