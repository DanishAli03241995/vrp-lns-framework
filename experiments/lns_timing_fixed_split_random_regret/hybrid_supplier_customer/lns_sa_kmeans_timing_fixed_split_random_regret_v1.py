...
fixed_timing_lns_module = importlib.import_module(
    ...
    "lns_sa_random_regret_fixed_timing_v1"
)
standard_lns_module = importlib.import_module(
    "metaheuristics.operator_pair_engines.lns_sa_random_regret_v1"
)

run_lns_sa_random_regret_fixed_timing = (
    fixed_timing_lns_module.run_lns_sa_random_regret_fixed_timing
)
...
def build_default_output_path(instance_name):
    ...
    return os.path.join(
        ROOT_DIR,
        "results",
        "lns_timing_fixed_split_random_regret",
        "case3_kmeans",
        instance_name,
    )
...
def run_lns_sa_experiment(
    ...
    print("\n===================================")
    print("FIXED TIMING SPLIT + RANDOM REGRET LNS OUTPUT FOLDER")
    print("===================================")
    print(save_path)
    ...
    with open(
        os.path.join(save_path, "route_lns_sa_fixed_timing_random_regret.txt"),
        "w",
    ) as file_handle:
        file_handle.write(str(all_lns_routes))
    ...
    plot_supplier_routes(
        ...
        title="Case 3 KMeans Fixed Timing Split + Random Regret LNS-SA Routes",
        depot_cord=depot_cord,
    )

    print("\n===================================")
    print("FIXED TIMING SPLIT + RANDOM REGRET LNS-SA COMPLETE")
    print("===================================")
