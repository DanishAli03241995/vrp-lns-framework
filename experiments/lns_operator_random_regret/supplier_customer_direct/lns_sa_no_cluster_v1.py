"""
Case 2: Supplier -> Customer Direct + No Internal Clustering + LNS-SA.
...
run_lns_sa_random_regret = lns_sa_module.run_lns_sa_random_regret
...
def run_lns_sa_experiment(
    ...
    print("\n===================================")
    print("RANDOM + REGRET LNS OUTPUT FOLDER")
    print("===================================")
    print(save_path)
    ...
    for supplier_id, supplier_data in supplier_metrics.items():
        ...
        best_solution, best_distance, operator_summary = (
        ...
        accepted_moves += operator_summary["accepted_moves"]
        rejected_moves += operator_summary["rejected_moves"]
        operator_records_by_supplier[str(supplier_id)] = operator_summary[
            "records"
        ]
        ...
        supplier_lns_metrics[supplier_id] = {
            ...
            "operator_pair": operator_summary["operator_pair"],
            "best_iteration": operator_summary["best_iteration"],
            "accepted_moves": operator_summary["accepted_moves"],
            "rejected_moves": operator_summary["rejected_moves"],
    ...
    operator_records_path = os.path.join(
        save_path,
        "operator_pair_records.json",
    )

    with open(operator_records_path, "w") as file_handle:
        json.dump(
            operator_records_by_supplier,
            file_handle,
            indent=4,
    ...
    lns_metrics = {
        "algorithm": "supplier_customer_lns_sa_no_cluster_random_regret_v1",
        "case": "Case_2_supplier_customer_direct",
        "clustering": "no_internal_clustering",
    ...
    with open(best_solution_path, "w") as file_handle:
        json.dump(
            lns_summary,
            file_handle,
            indent=4,
    ...
    plot_supplier_routes(
        ...
        title="Case 2 Direct No-Cluster + Random Regret LNS-SA Routes",
    )

    print("\n===================================")
    print("RANDOM + REGRET LNS-SA COMPLETE")
    print("===================================")
