"""Run generated depot-customer KMeans pipeline with the depot at map center."""
...
from experiments.depot_customer_kmeans import kmeans_pipeline_v1 as base
from instances.generate_depot_customer_instance import get_grid_size


base.ALGORITHM_NAME = "generated_depot_customer_kmeans_initial_pipeline_central_depot"
...
if __name__ == "__main__":
    for experiment_config in build_experiments():
        print("\n===================================")
        print("Running generated central-depot KMeans experiment:")
        print(experiment_config)
        print("===================================\n")
        base.run_generated_experiment(experiment_config)
