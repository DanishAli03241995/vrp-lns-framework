...
dispatch_wave_lns_module = importlib.import_module(
    ...
    "lns_sa_related_regret_dispatch_wave_speed40_v1"
)
...
def build_default_output_path(instance_name):
    ...
    return os.path.join(
        ROOT_DIR,
        "results",
        "lns_timing_waves_split_speed40_related_regret",
        "case3_kmeans",
        instance_name,
    )
...
def add_depot_timing_record_metadata(records):
    ...
    for record in records:
        ...
        enriched_record["operator_pair"] = "related_regret_dispatch_wave_speed40"
...
def run_lns_sa_experiment(
    ...
    print("\n===================================")
    print("DISPATCH-WAVE SPEED40 SPLIT + RELATED REGRET LNS OUTPUT FOLDER")
    print("===================================")
    print(save_path)
    ...
    with open(
        os.path.join(save_path, "route_lns_sa_dispatch_wave_speed40_related_regret.txt"),
        "w",
    ) as file_handle:
        file_handle.write(str(all_lns_routes))
    ...
    lns_metrics = {
        ...
        "operator_pair": "related_regret_dispatch_wave_speed40",
    ...
    try:
        plot_supplier_routes(
            ...
            title=(
                "Case 3 KMeans Dispatch-Wave Speed40 Split + Related-Regret LNS"
            ),
            depot_cord=depot_cord,
        )
    ...
    print("\n===================================")
    print("DISPATCH-WAVE SPEED40 RELATED-REGRET LNS SUMMARY")
    print("===================================")
