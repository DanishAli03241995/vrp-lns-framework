# Experiment entry point: Supplier -> Depot -> Customer baseline using Sweep clustering
...
def run_experiment(config):
    ...
    results_path = create_experiment_folder(
        "supplier_depot_customer_baseline_sweep_v1",
        INSTANCE_NAME,
    )
    ...
    metrics = {
        "algorithm": "supplier_depot_customer_baseline_sweep_v1",
    ...
    plot_routes(
        ...
        title="Vehicle Routes - Sweep + Baseline NN",
        supplier_cord=supplier_cord,
    )
    ...
    plot_routes(
        ...
        title="Vehicle Routes - Sweep + Baseline NN + 2-Opt",
        supplier_cord=supplier_cord,
    )
    ...
    plot_routes(
        ...
        title="Vehicle Routes - Sweep + Baseline NN + 2-Opt + Global 1-0 Relocation",
        supplier_cord=supplier_cord,
    )
    ...
    plot_routes(
        ...
        title="Vehicle Routes - Sweep + Baseline NN + 2-Opt + Global 1-0 Relocation + 2-Opt",
        supplier_cord=supplier_cord,
    )
