"""
Case 2: Supplier -> Customer Direct + Sweep + LNS-SA.
...
def run_lns_sa_experiment(
    ...
    lns_metrics = {
        "algorithm": "supplier_customer_lns_sa_sweep_related_greedy_v1",
    ...
    plot_supplier_routes(
        ...
        title="Case 2 Direct Sweep + Related Greedy LNS-SA Routes",
    )
