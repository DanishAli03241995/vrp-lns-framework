"""
Case 2: Supplier -> Customer Direct + No-Cluster + LNS-SA.
...
lns_sa_module = importlib.import_module(
    "metaheuristics.operator_pair_engines.lns_sa_related_greedy_v1"
)

run_lns_sa_related_greedy = lns_sa_module.run_lns_sa_related_greedy
...
def run_lns_sa_experiment(
    ...
    print("\n===================================")
    print("RELATED + GREEDY LNS OUTPUT FOLDER")
    print("===================================")
    print(save_path)
    ...
    lns_metrics = {
        "algorithm": "supplier_customer_lns_sa_no_cluster_related_greedy_v1",
    ...
    plot_supplier_routes(
        ...
        title="Case 2 Direct No-Cluster + Related Greedy LNS-SA Routes",
    )

    print("\n===================================")
    print("RELATED + GREEDY LNS-SA COMPLETE")
    print("===================================")
