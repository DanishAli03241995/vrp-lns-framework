...
def run_lns_sa_experiment(
    ...
    print("\n===================================")
    print("RELATED + GREEDY HYBRID LNS OUTPUT FOLDER")
    print("===================================")
    print(save_path)
    ...
    lns_metrics = {
        "algorithm": "hybrid_supplier_customer_lns_sa_no_cluster_related_greedy_v1",
    ...
    plot_supplier_routes(
        ...
        title="Case 3 Hybrid No-Cluster + Related Greedy LNS-SA Routes",
        depot_cord=depot_cord,
    )

    print("\n===================================")
    print("HYBRID RELATED + GREEDY LNS-SA COMPLETE")
    print("===================================")
