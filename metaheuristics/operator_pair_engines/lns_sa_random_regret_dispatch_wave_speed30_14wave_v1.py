...
split repair, specifically for the speed30 + 14:00-wave sensitivity run.
...
# =====================================================
# Main dispatch-wave random + regret LNS-SA engine
# =====================================================


def run_lns_sa_random_regret_dispatch_wave_speed30_14wave(
    initial_solution,
    constructed_dispatch_wave,
    demand,
    vehicle_capacity,
    ...
    """Run same-wave dispatch-aware LNS-SA using random removal and regret-2 insertion."""
    random.seed(seed)
    ...
    if not initial_validation["solution_feasible"]:
        raise ValueError(
            ...
            "Run wave-aware split repair before LNS, or verify speed30 + 14:00-wave inputs."
        )
...
if __name__ == "__main__":
    ...
    best, distance, run_summary = run_lns_sa_random_regret_dispatch_wave_speed30_14wave(
        ...
        dispatch_waves=[9.0, 11.0, 13.0, 14.0, 15.0],
