...
split repair, specifically for the speed30 + added 14:00-wave sensitivity run.
...
def evaluate_dispatch_wave_route(
    ...
    return {
        ...
        "lns_model": "same_wave_related_regret_lns",
    }
...
# Readable alias for this specific sensitivity case.
run_lns_sa_related_regret_dispatch_wave_speed30_14wave = (
