...
# =====================================================
# Main fixed-timing related + regret LNS-SA engine
# =====================================================


def run_lns_sa_related_regret_fixed_timing(
    initial_solution,
    ...
    """Run time-aware LNS-SA using Shaw-style related removal and regret-2 insertion."""
    random.seed(seed)
...
if __name__ == "__main__":
    ...
    best, distance, run_summary = run_lns_sa_related_regret_fixed_timing(
