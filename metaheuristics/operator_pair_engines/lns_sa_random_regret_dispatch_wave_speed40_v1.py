...
def run_lns_sa_random_regret_dispatch_wave_timing(
    initial_solution,
    constructed_dispatch_wave,
    demand,
    vehicle_capacity,
    ...
    for iteration in range(n_iterations):
        ...
        records.append({
            ...
            "operator_pair": "random_regret_dispatch_wave_timing",
...
if __name__ == "__main__":
    ...
    best, distance, run_summary = run_lns_sa_random_regret_dispatch_wave_timing(
