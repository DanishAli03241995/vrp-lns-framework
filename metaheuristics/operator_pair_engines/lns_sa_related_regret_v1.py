"""
LNS-SA engine for Shaw-style Related Removal + Regret-2 Insertion.
"""
...
if __name__ == "__main__":
    ...
    best_solution, best_distance, summary = run_lns_sa_related_regret(
